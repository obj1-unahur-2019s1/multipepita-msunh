...
object pepita {
    ...
    // implementar OK
	method estaFeliz() {return energia.between(500,1000) }  // OK - implementar
	
	method cuantoQuiereVolar() { 
		var cuanto = energia / 5
		if (energia.between(300, 400)) { cuanto += 10 } //si la energia esta entre 300 y 400 entonces suma 10 / between(entre)
		if (energia % 20 == 0) { cuanto += 15 } // si la energia es multiplo de 20 entonces entonces suma 15km (% da como resultado el resto de la division, si es cero es multiplo de 20)
		return cuanto
	}
